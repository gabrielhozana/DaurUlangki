...
public class PostActivity extends AppCompatActivity {
    ...
    TextView tvPost;
    EditText edtDesription, edtJudul, edtLokasi, edtHarga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtDesription = findViewById(R.id.edtDesription);
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        DatabaseReference reference = FirebaseDatabase.getInstance().getInstance().getReference("Posts");
                        ...
                        hashMap.put("title", edtJudul.getText().toString());
                        hashMap.put("price", "Rp "+ edtHarga.getText().toString());
                        hashMap.put("location", edtLokasi.getText().toString());
                        hashMap.put("description", edtDesription.getText().toString());
